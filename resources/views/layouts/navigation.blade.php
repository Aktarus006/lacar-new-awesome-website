    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6">
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
          ...
          -->
            ...
            <div class="-my-2 -mr-2 xl:hidden" x-data="{ id : 'mobile-menu'}">
    ...
    <div x-data="{ isOpen : false }" x-show="isOpen"
        ...
        <div class="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
                ...
                <div class="mt-6">
                    <nav class="grid gap-y-8">
                        <a href="#" class="flex items-center p-3 -m-3 rounded-md hover:bg-gray-50">
                            ...
                            <span class="ml-3 text-base font-light text-gray-900">
                                Analytics
                            </span>
                        </a>
            ...
            <div class="px-5 py-6 space-y-6">
                ...
                <div>
                    <a href="/contact"
                        class="flex items-center justify-center w-full px-4 py-2 text-base font-light text-white uppercase bg-yellow-500 border border-transparent rounded-md shadow-sm hover:bg-yellow-700">
                        Contact us
                    </a>
                </div>
            </div>
