    ...
    <div class="lg:absolute lg:inset-0">
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="object-cover w-full h-56 lg:absolute lg:h-full"
                src="https://images.unsplash.com/photo-1556761175-4b46a572b786?ixlib=rb-1.2.1&ixqx=AXQIJjKewm&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1567&q=80"
                alt="">
        </div>
    </div>
        ...
        <div class="lg:pr-8">
                ...
                <div class="w-full p-5 bg-green-100 rounded-md">
                    <div class="flex justify-between">
                        <div class="flex space-x-3">
                            ...
                            <div class="flex-1 text-sm font-medium leading-tight text-green-700">{{ $success }}</div>
                        </div>
                    </div>
                </div>
                @endif
            ...
            <form action="{{ action('App\Http\Controllers\ContactFormController@contactForm') }}" method="POST"
                ...
                <div class="sm:col-span-2">
                    ...
                    <p class="mt-2 text-sm text-red-600" id="full_name-error">{{ $errors->first('full_name') }}</p>
                    @else
                    <div class="relative mt-1 rounded-md shadow-sm">
                ...
                <div class="sm:col-span-2">
                    <div class="inline-flex justify-center g-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}">
                    </div>
